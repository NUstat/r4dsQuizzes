...
q2[[1]] <- HTML("Consider the dataset named <code>relig_income</code>. Tidy the dataset so that it has 3 columns named <code>religion</code>, <code>income_range</code>, and <code>count</code>.")

q2[[2]] <- HTML("Consider the dataset named <code>example_eagle_nests</code>. Tidy the dataset so that it has 3 columns named <code>region</code>, <code>year</code>, and <code>num_nests</code>.")

q2[[3]] <- HTML("Consider the dataset named <code>example_eagle_pairs</code>. Tidy the dataset so that it has 4 columns named <code>state</code>, <code>state_abbr</code>, <code>year</code>, and <code>num_pairs</code>.")

q2[[4]] <- HTML("Consider the dataset named <code>example_migration</code>. Tidy the dataset so that it has 3 columns named <code>dest</code>, <code>origins</code>, and <code>migrants</code>. Drop the NA values.")

q2[[5]] <- HTML("Consider the dataset named <code>table_1</code>. Tidy the dataset so that it has 4 columns named <code>country</code>, <code>year</code>, <code>type</code>, and <code>count</code>.")

q2[[6]] <- HTML("Consider the dataset named <code>example_eagle_nests_tidy</code>. Untidy the dataset so that it has 3 columns named <code>region</code>, <code>2007</code>, and </ode>2009</code>.")

q2[[7]] <- HTML("Consider the dataset named <code>example_acs_1</code>. Untidy the dataset so that it has 5 columns named <code>geoid</code>, <code>name</code>, <code>pop_housed</code>, <code>pop_renter</code>, and <code>median_rent</code>.")
...
q3[[4]] <- HTML("Consider a dataset named <code>mpg_data</code> located in a <code>data</code> subdirectory. The file is a csv extension with comma separated values. Use an appropriate <code>readr</code> function to read the dataset in and store the dataset as <code>mpg_raw</code>.")

q3[[5]] <- HTML("Consider a dataset named <code>diamonds_data</code> located in a <code>data</code> subdirectory. The file is a csv extension with comma separated values. Use an appropriate <code>readr`</code> function to read the dataset in and store the dataset as <code>diamonds_raw</code>.")

q3[[6]] <- HTML("Consider a dataset named <code>penguins_data</code> located in a <code>data</code> subdirectory. The file is an rds extension. Use an appropriate <code>readr</code> function to read the dataset in and store the dataset as <code>penguins_raw</code>.")
...
q4[[1]] <- HTML("Manually input the data table below using the <code>tibble()</code> function. Store this data frame as <code>report_card</code> and print the output.")

q4[[2]] <- HTML("Manually input the data table below using the <code>tribble()</code> function. Store this data frame as <code>report_card</code> and print the output.")

q4[[3]] <- HTML("Manually input the data table below using the <code>tibble()</code> function. Store this data frame as <code>coffee</code> and print the output.")

q4[[4]] <- HTML("Manually input the data table below using the <code>tribble()</code> function. Store this data frame as <code>coffee</code> and print the output.")

q4[[5]] <- HTML("Manually input the data table below using the <code>tibble()</code> function. Store this data frame as <code>my_table</code> and print the output.")

q4[[6]] <- HTML("Manually input the data table below using the <code>tribble()</code> function. Store this data frame as <code>my_table</code> and print the output.")


q4[[7]] <- HTML("Consider the dataset named <code>messy</code>. It has already been pre-loaded for you. Create a new column called <code>diff</code> which is <code>2023</code> minus <code>2022</code>.")

q4[[8]] <- HTML("Consider the dataset named <code>messy</code>. It has already been pre-loaded for you. Create a new column called <code>2024</code> which is <code>2022</code> times <code>2023</code>.")
...
babies_codebook <- tibble(variable = c("case", "bwt", "gestation", "parity", "age", "height", "weight", "smoke"),
                          meaning = c("id number", 
                                      ...
                                      "binary indicator for whether the mother smokes (1 = smokes)"))

nc_births_codebook <- tibble(variable = c("fage", "mage", "mature", "weeks", "premie", "visits", "gained", "weight", "lowbirthweight", "gender", "habit", "marital", "whitemom"),
                             meaning = c("Father's age in years", 
                                         "Mother's age in years",
...
fastfood_codebook <- tibble(variable = c("restaurant", "item", "calories", "cal_fat", "total_fat", "sat_fat", "trans_fat", "cholesterol", "sodium", "total_carb", "fiber", "sugar", "protien", "vit_a", "vit_c", "calcium", "salad"),
                            meaning = c("Name of restaurant", "Name of item", "Number of calories", "calories from fat", "total fat", "saturated fat", "trans fat", "cholesterol", "sodium", "total carbohydrates", "fiber", "sugar", "protien", "vitamin a", "vitamin c", "calcium", "salad or not"))
...
q5[[1]] <- HTML("Use functions from the <code>naniar</code> package to check for missingness issues in the dataset called <code>babies</code>. Explore the dataset and check for any weird values. Submit any relevant work in the code chunk. Describe the dataset and any issues in the provided text block below.")

q5[[2]] <- HTML("Use functions from the <code>naniar</code> package to check for missingness issues in the dataset called <code>ncbirths</code>. Explore the dataset and check for any weird values. Submit any relevant work in the code chunk. Describe the dataset and any issues in the provided text block below.")

q5[[3]] <- HTML("Use functions from the <code>naniar</code> package to check for missingness issues in the dataset called <code>fastfood</code>. Explore the dataset and check for any weird values. Submit any relevant work in the code chunk. Describe the dataset and any issues in the provided text block below.")
