...
# mod_penguin <- read_csv("data/mod_penguin.csv")
# raw_penguin <- read_csv("data/raw_penguin.csv")

mod_penguin_07 <- read_csv("data/mod_penguin_07.csv")
mod_penguin_08 <- read_csv("data/mod_penguin_08.csv")
# mod_penguin_09 <- read_csv("data/mod_penguin_09.csv")
...
if(sample_data == 1){
  q2[[1]] <- HTML("Combine <code>pizza_order</code> and <code>pizza_delivery</code> to find out who's <code>price</code> was the most expensive. <br> <br> <b>Print only</b> the observation(s) with the most expensive order.")
  q2[[2]] <- HTML("Combine <code>pizza_order</code> and <code>pizza_delivery</code> to find out who's <code>price</code> was the least expensive. <br> <br> <b>Print only</b> the observation(s) with the least expensive order.")
} else if(sample_data == 2){
  ...
  q2[[1]] <- HTML("Use an appropriate <code>join</code> to combine the <code>football</code> and <code>chi_weather</code> dataset so that you can determine if there is a relationship between <code>passing_yds</code> and <code>windspeed</code>. <br> <br> <b>Print only</b> a scatterplot of the relationship to prove you were successful.")
  q2[[2]] <- HTML("Use an appropriate <code>join</code> to combine the <code>football</code> and <code>chi_weather</code> dataset so that you can determine if there is a relationship between <code>avg_passing_yds</code> and <code>icon</code>. <br> <br> <b>Print only</b> a side-by-side boxplot of the relationship between <code>avg_passing_yds</code> and <code>icon</code> to prove you were successful.")
}
...
Test your function using the <code>pizza_delivery</code> dataset, <code>price</code> variable, and color of your choice.")
  q3[[2]] <-  HTML("Write a function that creates a histogram given a dataset, numeric variable, and number of bins. <br> <br> 
Test your function using the <code>pizza_delivery</code> dataset, <code>price</code> variable, and <code>bins</code> value of your choice.")
} else if(sample_data == 2){
  q3[[1]] <-  HTML("Write a function that creates a histogram given a dataset, numeric variable, and fill. The <code>fill</code> argument should be a fixed value not a variable, for example 'red'. <br> <br> 
Test your function using the <code>medical_record</code> dataset, <code>max_hr</code> variable, and <code>fill</code> of your choice.")
...
Test your function using the <code>mod_penguin_08</code> dataset, <code>species</code> variable, and <code>flipper_length_mm</code> variable.")
